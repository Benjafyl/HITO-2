...
-- Indices adicionales para el Hito 3.
-- Optimizan el endpoint GET /flights, que ordena por departure_date,
-- filtra vuelos cancelados y agrupa reservas confirmadas por flight_id.
CREATE INDEX idx_flights_route_departure ON flights(route_id, departure_date);
CREATE INDEX idx_flights_status_departure ON flights(status, departure_date);
